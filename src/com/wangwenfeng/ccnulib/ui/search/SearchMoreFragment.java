...
public class SearchMoreFragment extends SearchMoreFragmentBase {

	public SearchMoreFragment(Activity activity, Context context) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mView = inflater.inflate(R.layout.search_more, container, false);
		findViewById();
		setListener();
		init();
		return mView;
