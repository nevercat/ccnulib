...
public class LibActionBar extends LinearLayout implements OnClickListener {
	...
	public LibActionBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray array = context.obtainStyledAttributes(attrs,
				R.styleable.LibActionBar);

		View titieView = LayoutInflater.from(context).inflate(
				R.layout.lib_action_bar, null);
		addView(titieView, new LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.WRAP_CONTENT));

		mIvArrow = (ImageView) titieView
				.findViewById(R.id.lib_acitonbar_title_arrows);
		mIvIcon = (ImageView) titieView
				.findViewById(R.id.lib_acitonbar_title_icon);
		mLlParent = (LinearLayout) titieView
				.findViewById(R.id.lib_acitonbar_title_parent);
		mTvTitle = (TextView) titieView
				.findViewById(R.id.lib_acitonbar_title_title);
		mTvTitle2 = (TextView) titieView
				.findViewById(R.id.lib_acitonbar_title_title2);
		mTvTitle3 = (TextView) titieView
				.findViewById(R.id.lib_acitonbar_title_title3);
		mTvVisits = (TextView) titieView
				.findViewById(R.id.lib_acitonbar_title_visits);
		mTvMsgNum = (TextView) titieView
				.findViewById(R.id.lib_acitonbar_title_msg_num);
		mIvFilterPointer = (ImageView) titieView
				.findViewById(R.id.lib_acitonbar_title_filterpointer);
		mIbMenu = (ImageButton) titieView
				.findViewById(R.id.lib_acitonbar_title_menu);

		mIcon = array.getResourceId(R.styleable.LibActionBar_icon, -1);
		mTitle = array.getString(R.styleable.LibActionBar_title);
		mTitle2 = array.getString(R.styleable.LibActionBar_title2);
		mTitle3 = array.getString(R.styleable.LibActionBar_title3);
		mVisits = array.getString(R.styleable.LibActionBar_visits);
		mMsgNum = array.getString(R.styleable.LibActionBar_msgnum);
		mMenu = array.getResourceId(R.styleable.LibActionBar_menu, -1);
		mStyle = array.getInt(R.styleable.LibActionBar_style, 0);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.lib_acitonbar_title_arrows:
			if (mOnBackClickListener != null) {
				mOnBackClickListener.onBackClick();
			}
			break;
		case R.id.lib_acitonbar_title_parent:
			if (mStyle == MENU) {
			...
			break;
		case R.id.lib_acitonbar_title_menu:
	...
	public void showTitlePopupwindow() {
		mLlParent.setBackgroundResource(R.drawable.lib_title_shadow_bg);
